...
/bin/bash "$SCRIPT_DIR/tasks/clean.sh"

echo ""
echo ">>> Paso 2: Construyendo imagen Docker de API con Jib..."
/bin/bash "$SCRIPT_DIR/tasks/build-api.sh"

echo ""
echo ">>> Paso 3: Desplegando servicios de Backend (DB y API)..."
/bin/bash "$SCRIPT_DIR/tasks/deploy.sh"
